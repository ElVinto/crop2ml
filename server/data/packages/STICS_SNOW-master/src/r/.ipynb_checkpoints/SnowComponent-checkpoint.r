...
model_snow <- function (jul = 0,
    ...
    Snowmelt <- model_snowmelt(Snowmelt_t1, ps, M)
    ...
    return (list ("tmaxrec" = tmaxrec,"ps" = ps,"Mrf" = Mrf,"tavg" = tavg,"Swet" = Swet,"Snowmelt" = Snowmelt,"Snowaccu" = Snowaccu,"Sdry" = Sdry,"Sdepth" = Sdepth,"tminrec" = tminrec,"M" = M,"preciprec" = preciprec))
}